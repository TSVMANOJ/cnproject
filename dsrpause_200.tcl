...
set val(ifq)    Queue/DropTail/CMUPriQueue   ;# interface queue type
...
set tracefile [open dsrpause_200.tr w]
$ns_ trace-all $tracefile
#$ns use-newtrace
#Open the NAM trace file
set namfile [open dsrpause_200.nam w]
